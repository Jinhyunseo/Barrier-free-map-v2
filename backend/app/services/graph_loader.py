...
from app.core.data_paths import STATION_GRAPHS_V1_INDIVIDUAL_DIR
from app.schemas.station_graph import StationGraph


# station json 파일들이 저장된 위치
STATION_DATA_DIR = STATION_GRAPHS_V1_INDIVIDUAL_DIR
...
def get_station_json_path(station_name: str) -> Path:
    ...
    예:
        "yatap" -> app/data/stations/graphs/v1/individual/yatap.json
    """
