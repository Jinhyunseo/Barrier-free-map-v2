...
from app.core.data_paths import STATION_FACILITIES_BY_LINE_DIR, STATION_GRAPHS_V1_DIR, STATION_GRAPHS_V1_FILE
from app.station_config.station_metadata import STATION_METADATA
from app.station_config.station_layouts import STATION_LAYOUTS
from app.station_config.graph_configs import get_station_graph_config
...
FACILITY_DATA_DIR = STATION_FACILITIES_BY_LINE_DIR
GRAPH_DATA_DIR = STATION_GRAPHS_V1_DIR
OUTPUT_FILE = STATION_GRAPHS_V1_FILE
...
def build_station_graph(
    ...
    for line_index, (line_name, line_metadata) in enumerate(lines.items(), start=1):
        ...
        integrated_source = "station_facilities.json"
