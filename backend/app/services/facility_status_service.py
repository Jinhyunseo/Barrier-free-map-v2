...
from app.core.data_paths import STATION_REALTIME_CURRENT_DIR
from app.station_config.realtime_facility_mapping import (
...
REALTIME_DATA_DIR = STATION_REALTIME_CURRENT_DIR
...
def get_station_json_path(
    ...
    return REALTIME_DATA_DIR / f"{get_station_file_slug(station_name)}_equipment_status.json"
