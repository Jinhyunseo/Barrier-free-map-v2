...
from app.core.data_paths import STATION_FACILITIES_BY_LINE_DIR, STATION_FACILITIES_FILE
from app.station_config.station_metadata import (
...
INTEGRATED_FACILITY_FILE = STATION_FACILITIES_FILE
...
def _load_integrated_facility_data(
    ...
    """
    station_facilities.json 전체를 읽습니다.
    """
