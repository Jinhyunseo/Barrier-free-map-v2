...
from app.core.data_paths import STATION_GRAPHS_V2_DIR
...
#
# 그래프 데이터:
# backend/app/data/stations/graphs/v2/
# ==================================================

STATION_DATA_DIR = STATION_GRAPHS_V2_DIR
...
def get_station_json_path(station_name: str) -> Path:
    ...
    예:
        "taepyeong"
        -> backend/app/data/stations/graphs/v2/taepyeong.json
    """
